        ...
        <div className="container py-7 mx-auto">
          <div className="lg:w-4/5 mx-auto flex flex-wrap">
            ...
            <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
              ...
              <div className="pin mt-10 space-x-2 flex">
                <input
                  onChange={onChangePin}
                  className="border-2 border-pink-300 py-1 px-2 rounded-md"
                  type="text"
                  name="text"
                ...
                <button
                  ...
                  className="text-white flex bg-indigo-500 duration-500 border-0 py-2 px-6 focus:outline-none hover:bg-indigo-600 rounded"
                >
                  <FiMapPin className="mt-[4px] mr-[5px]" />
                  Check
                </button>
              </div>
